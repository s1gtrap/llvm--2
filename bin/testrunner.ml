...
let () =
  ...
  |> t "tests/llvm-ok/20000121-1.ll" []
  |> t "tests/llvm-ok/20000703-1.ll" []
  |> t "tests/llvm-ok/20000707-1.ll" []
  |> t "tests/llvm-ok/20000715-2.ll" []
  |> t "tests/llvm-ok/20000801-1.ll" []
  |> t "tests/llvm-ok/20000801-2.ll" []
  |> t "tests/llvm-ok/20000910-2.ll" []
  |> t "tests/llvm-ok/20001011-1.ll" []
  |> t "tests/llvm-ok/20010116-1.ll" []
  |> t "tests/llvm-ok/20010123-1.ll" []
  |> t "tests/llvm-ok/20010325-1.ll" []
  |> t "tests/llvm-ok/20010717-1.ll" []
  (*|> t "tests/llvm-ok/20010910-1.ll" []*)
  |> t "tests/llvm-ok/20011008-3.ll" []
  |> t "tests/llvm-ok/20011115-1.ll" []
  |> t "tests/llvm-ok/20011126-2.ll" []
  ...
  |> t "tests/llvm-ok/2002-10-13-BadLoad.ll" []
  |> t "tests/llvm-ok/20020103-1.ll" []
  (*|> t "tests/llvm-ok/20020108-1.ll" []*)
  |> t "tests/llvm-ok/20020127-1.ll" []
  |> t "tests/llvm-ok/20020201-1.ll" []
  |> t "tests/llvm-ok/20020206-2.ll" []
  (*|> t "tests/llvm-ok/20020216-1.ll" []*)
  |> t "tests/llvm-ok/20020219-1.ll" []
  |> t "tests/llvm-ok/20020225-1.ll" []
  |> t "tests/llvm-ok/20020320-1.ll" []
  (*|> t "tests/llvm-ok/20020402-1.ll" []*)
  |> t "tests/llvm-ok/20020402-3.ll" []
  |> t "tests/llvm-ok/20020423-1.ll" []
  |> t "tests/llvm-ok/20020503-1.ll" []
  |> t "tests/llvm-ok/20020506-1.ll" []
  |> t "tests/llvm-ok/20020510-1.ll" []
  |> t "tests/llvm-ok/20020614-1.ll" []
  |> t "tests/llvm-ok/20020716-1.ll" []
  |> t "tests/llvm-ok/20020805-1.ll" []
  |> t "tests/llvm-ok/20020911-1.ll" []
  |> t "tests/llvm-ok/20021015-1.ll" []
  |> t "tests/llvm-ok/20021118-3.ll" []
  |> t "tests/llvm-ok/20021119-1.ll" []
  |> t "tests/llvm-ok/20021127-1.ll" []
  |> t "tests/llvm-ok/20021204-1.ll" []
  |> t "tests/llvm-ok/20021219-1.ll" []
  |> t "tests/llvm-ok/2003-04-22-Switch.ll" []
  |> t "tests/llvm-ok/2003-05-02-DependentPHI.ll" []
  |> t "tests/llvm-ok/2003-05-12-MinIntProblem.ll" []
  ...
  (*|> t "tests/llvm-ok/2003-10-29-ScalarReplBug.ll" []*)
  |> t "tests/llvm-ok/20030120-2.ll" []
  |> t "tests/llvm-ok/20030203-1.ll" []
  |> t "tests/llvm-ok/20030221-1.ll" []
  |> t "tests/llvm-ok/20030307-1.ll" []
  |> t "tests/llvm-ok/20030313-1.ll" []
  ...
  |> t "tests/llvm-ok/20030920-1.ll" []
  |> t "tests/llvm-ok/20031011-1.ll" []
  |> t "tests/llvm-ok/20031020-1.ll" []
  ...
  |> t "tests/llvm-ok/20040409-1w.ll" []
  |> t "tests/llvm-ok/20040409-2.ll" []
  |> t "tests/llvm-ok/20040409-2w.ll" []
  |> t "tests/llvm-ok/20040409-3.ll" []
  |> t "tests/llvm-ok/20040409-3w.ll" []
  |> t "tests/llvm-ok/20040704-1.ll" []
  |> t "tests/llvm-ok/20040820-1.ll" []
  |> t "tests/llvm-ok/20041126-1.ll" []
  (*|> t "tests/llvm-ok/20041201-1.ll" []*)
  |> t "tests/llvm-ok/20041213-2.ll" []
  |> t "tests/llvm-ok/2005-05-06-LongLongSignedShift.ll" []
  (*|> t "tests/llvm-ok/2005-05-13-SDivTwo.ll" []*)
  |> t "tests/llvm-ok/2005-07-15-Bitfield-ABI.ll" []
  |> t "tests/llvm-ok/2005-11-29-LongSwitch.ll" []
  |> t "tests/llvm-ok/20050104-1.ll" []
  |> t "tests/llvm-ok/20050106-1.ll" []
  |> t "tests/llvm-ok/20050107-1.ll" []
  |> t "tests/llvm-ok/20050111-1.ll" []
  (*|> t "tests/llvm-ok/20050119-1.ll" []*)
  |> t "tests/llvm-ok/20050119-2.ll" []
  |> t "tests/llvm-ok/20050124-1.ll" []
  |> t "tests/llvm-ok/20050224-1.ll" []
  |> t "tests/llvm-ok/20050502-1.ll" []
  |> t "tests/llvm-ok/20050502-2.ll" []
  (*|> t "tests/llvm-ok/20050713-1.ll" []*)
  |> t "tests/llvm-ok/20050826-2.ll" []
  |> t "tests/llvm-ok/20051215-1.ll" []
  |> t "tests/llvm-ok/2006-12-07-Compare64BitConstant.ll" []
  |> t "tests/llvm-ok/2006-12-11-LoadConstants.ll" []
  |> t "tests/llvm-ok/20060110-1.ll" []
  |> t "tests/llvm-ok/20060110-2.ll" []
  |> t "tests/llvm-ok/20060127-1.ll" []
  |> t "tests/llvm-ok/20060929-1.ll" []
  |> t "tests/llvm-ok/20060930-1.ll" []
  |> t "tests/llvm-ok/20061101-1.ll" []
  |> t "tests/llvm-ok/20061101-2.ll" []
  |> t "tests/llvm-ok/2007-04-10-BitfieldTest.ll" []
  |> t "tests/llvm-ok/20070201-1.ll" []
  |> t "tests/llvm-ok/20070212-1.ll" []
  |> t "tests/llvm-ok/20070212-2.ll" []
  |> t "tests/llvm-ok/20070212-3.ll" []
  |> t "tests/llvm-ok/20070424-1.ll" []
  |> t "tests/llvm-ok/20070724-1.ll" []
  |> t "tests/llvm-ok/20070824-1.ll" []
  |> t "tests/llvm-ok/20071011-1.ll" []
  |> t "tests/llvm-ok/20071018-1.ll" []
  |> t "tests/llvm-ok/20071205-1.ll" []
  |> t "tests/llvm-ok/20080222-1.ll" []
  |> t "tests/llvm-ok/20080408-1.ll" []
  |> t "tests/llvm-ok/20080506-1.ll" []
  |> t "tests/llvm-ok/20080506-2.ll" []
  |> t "tests/llvm-ok/20080522-1.ll" []
  |> t "tests/llvm-ok/20080719-1.ll" []
  |> t "tests/llvm-ok/20080813-1.ll" []
  |> t "tests/llvm-ok/20081112-1.ll" []
  (*|> t "tests/llvm-ok/20081117-1.ll" []*)
  |> t "tests/llvm-ok/20090207-1.ll" []
  |> t "tests/llvm-ok/20090527-1.ll" []
  |> t "tests/llvm-ok/20090711-1.ll" []
  (*|> t "tests/llvm-ok/20100209-1.ll" []*)
  |> t "tests/llvm-ok/20100416-1.ll" []
  |> t "tests/llvm-ok/20100805-1.ll" []
  |> t "tests/llvm-ok/20100827-1.ll" []
  |> t "tests/llvm-ok/20101013-1.ll" []
  |> t "tests/llvm-ok/20110418-1.ll" []
  |> t "tests/llvm-ok/20111212-1.ll" []
  (*> t "tests/llvm-ok/20111227-1.ll" []*)
  |> t "tests/llvm-ok/20120111-1.ll" []
  |> t "tests/llvm-ok/20120207-1.ll" []
  |> t "tests/llvm-ok/20120615-1.ll" []
  |> t "tests/llvm-ok/20140212-2.ll" []
  |> t "tests/llvm-ok/20140326-1.ll" []
  |> t "tests/llvm-ok/20140425-1.ll" []
  (*|> t "tests/llvm-ok/20140828-1.ll" []*)
  |> t "tests/llvm-ok/20141022-1.ll" []
  |> t "tests/llvm-ok/20141107-1.ll" []
  |> t "tests/llvm-ok/20141125-1.ll" []
  |> t "tests/llvm-ok/20170111-1.ll" []
  (*|> t "tests/llvm-ok/20180131-1.ll" []*)
  |> t "tests/llvm-ok/20180226-1.ll" []
  |> t "tests/llvm-ok/920612-1.ll" []
  |> t "tests/llvm-ok/920711-1.ll" []
  |> t "tests/llvm-ok/990211-1.ll" []
  |> t "tests/llvm-ok/FarJump.ll" []
  |> t "tests/llvm-ok/MultipleSetjmp.ll" []
  |> t "tests/llvm-ok/SSAtest.ll" []
  |> t "tests/llvm-ok/TestLoop.ll" []
  ...
  |> t "tests/llvm-ok/bitbit.ll" []
  |> t "tests/llvm-ok/bitfld-2.ll" []
  (*|> t "tests/llvm-ok/bitfld-4.ll" []*)
  |> t "tests/llvm-ok/bitfld-6.ll" []
  |> t "tests/llvm-ok/bitfld-7.ll" []
  |> t "tests/llvm-ok/bitlogic.ll" []
  (*|> t "tests/llvm-ok/bswap-2.ll" []*)
  |> t "tests/llvm-ok/call-trap-1.ll" []
  |> t "tests/llvm-ok/cast-bug.ll" []
  |> t "tests/llvm-ok/compare.ll" []
  |> t "tests/llvm-ok/compare-1.ll" []
  ...
  |> t "tests/llvm-ok/lshrdi-1.ll" []
  |> t "tests/llvm-ok/matrix.ll" []
  |> t "tests/llvm-ok/mayalias-1.ll" []
  |> t "tests/llvm-ok/mayalias-2.ll" []
  |> t "tests/llvm-ok/memory.ll" []
  |> t "tests/llvm-ok/memset-4.ll" []
  (*|> t "tests/llvm-ok/methcall.ll" []*)
  |> t "tests/llvm-ok/mips16_32_4.ll" []
  |> t "tests/llvm-ok/ms_struct-bitfield-1.ll" []
  (*|> t "tests/llvm-ok/ms_struct_pack_layout.ll" []*)
  |> t "tests/llvm-ok/ms_struct_pack_layout-1.ll" []
  |> t "tests/llvm-ok/nestedloop.ll" []
  (*|> t "tests/llvm-ok/nsieve-bits.ll" []*)
  |> t "tests/llvm-ok/pointer.ll" []
  |> t "tests/llvm-ok/pointer_arithmetic.ll" []
  (*|> t "tests/llvm-ok/pr16790-1.ll" []*)
  |> t "tests/llvm-ok/pr17078-1.ll" []
  |> t "tests/llvm-ok/pr19449.ll" []
  |> t "tests/llvm-ok/pr19515.ll" []
  (*|> t "tests/llvm-ok/pr19687.ll" []*)
  |> t "tests/llvm-ok/pr20187-1.ll" []
  |> t "tests/llvm-ok/pr20466-1.ll" []
  |> t "tests/llvm-ok/pr20527-1.ll" []
  |> t "tests/llvm-ok/pr22348.ll" []
  |> t "tests/llvm-ok/pr22429.ll" []
  |> t "tests/llvm-ok/pr22493-1.ll" []
  |> t "tests/llvm-ok/pr23047.ll" []
  |> t "tests/llvm-ok/pr23604.ll" []
  |> t "tests/llvm-ok/pr24142.ll" []
  |> t "tests/llvm-ok/pr24716.ll" []
  |> t "tests/llvm-ok/pr24851.ll" []
  (*|> t "tests/llvm-ok/pr25125.ll" []*)
  |> t "tests/llvm-ok/pr27671-1.ll" []
  |> t "tests/llvm-ok/pr28651.ll" []
  |> t "tests/llvm-ok/pr28778.ll" []
  |> t "tests/llvm-ok/pr29695-1.ll" []
  |> t "tests/llvm-ok/pr29695-2.ll" []
  |> t "tests/llvm-ok/pr29797-1.ll" []
  |> t "tests/llvm-ok/pr29797-2.ll" []
  |> t "tests/llvm-ok/pr31169.ll" []
  |> t "tests/llvm-ok/pr33631.ll" []
  |> t "tests/llvm-ok/pr33669.ll" []
  |> t "tests/llvm-ok/pr33779-1.ll" []
  |> t "tests/llvm-ok/pr33779-2.ll" []
  ...
  |> t "tests/llvm-ok/pr58387.ll" []
  |> t "tests/llvm-ok/pr59014-2.ll" []
  |> t "tests/llvm-ok/pr59101.ll" []
  |> t "tests/llvm-ok/pr59358.ll" []
  ...
  |> t "tests/llvm-ok/pta-field-1.ll" []
  |> t "tests/llvm-ok/pta-field-2.ll" []
