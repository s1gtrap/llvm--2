...
define i8* @tigermain (i8* %$sl) {
 ...
 %size_ptr_$_2 = getelementptr %intlist$0, %intlist$0* null, i64 1
 ...
 %field_ptr_$_6 = getelementptr %intlist$0, %intlist$0* %rec_$_5, i64 0, i64 0
 store i64 0, i64* %field_ptr_$_6
 %field_ptr_$_7 = getelementptr %intlist$0, %intlist$0* %rec_$_5, i64 0, i64 1
 store i8* null, i8** %field_ptr_$_7
 %temp_$_8 = getelementptr %$locals_tigermain, %$locals_tigermain* %locals_$_0, i64 0, i64 1
 store i8* %record_ptr_$_4, i8** %temp_$_8
 %var_ptr_$_9 = getelementptr %$locals_tigermain, %$locals_tigermain* %locals_$_0, i64 0, i64 1
