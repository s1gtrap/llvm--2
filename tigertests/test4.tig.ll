...
define i64 @nfactor$0 (%$locals_tigermain* %$sl, i64 %n$1) {
 ...
 %arg_$_2 = getelementptr %$locals_nfactor$0, %$locals_nfactor$0* %locals_$_0, i64 0, i64 1
 store i64 %n$1, i64* %arg_$_2
 %arg_$_3 = getelementptr %$locals_nfactor$0, %$locals_nfactor$0* %locals_$_0, i64 0, i64 0
 store %$locals_tigermain* %$sl, %$locals_tigermain** %arg_$_3
 %var_ptr_$_8 = getelementptr %$locals_nfactor$0, %$locals_nfactor$0* %locals_$_0, i64 0, i64 1
...
thn_$_5:
 ...
 br label %mrg_$_7
els_$_6:
 %var_ptr_$_13 = getelementptr %$locals_nfactor$0, %$locals_nfactor$0* %locals_$_0, i64 0, i64 1
 %res_$_14 = load i64, i64* %var_ptr_$_13
 %lnk_$_15 = getelementptr %$locals_nfactor$0, %$locals_nfactor$0* %locals_$_0, i64 0, i64 0
 %load_$_16 = load %$locals_tigermain*, %$locals_tigermain** %lnk_$_15
 %var_ptr_$_17 = getelementptr %$locals_nfactor$0, %$locals_nfactor$0* %locals_$_0, i64 0, i64 1
...
define i64 @tigermain (i8* %$sl) {
 ...
 %arg_$_23 = getelementptr %$locals_tigermain, %$locals_tigermain* %locals_$_1, i64 0, i64 0
