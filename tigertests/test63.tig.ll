...
define i64 @isdigit$0 (%$locals_tigermain* %$sl, i8* %s$1) {
 ...
 %arg_$_2 = getelementptr %$locals_isdigit$0, %$locals_isdigit$0* %locals_$_0, i64 0, i64 1
 store i8* %s$1, i8** %arg_$_2
 %arg_$_3 = getelementptr %$locals_isdigit$0, %$locals_isdigit$0* %locals_$_0, i64 0, i64 0
 store %$locals_tigermain* %$sl, %$locals_tigermain** %arg_$_3
 %lnk_$_8 = getelementptr %$locals_isdigit$0, %$locals_isdigit$0* %locals_$_0, i64 0, i64 0
 %load_$_9 = load %$locals_tigermain*, %$locals_tigermain** %lnk_$_8
 %var_ptr_$_11 = getelementptr %$locals_isdigit$0, %$locals_isdigit$0* %locals_$_0, i64 0, i64 1
 %res_$_12 = load i8*, i8** %var_ptr_$_11
 %ret_$_13 = call i64 @ord (i8* null, i8* %res_$_12)
 %lnk_$_14 = getelementptr %$locals_isdigit$0, %$locals_isdigit$0* %locals_$_0, i64 0, i64 0
...
thn_$_5:
 %lnk_$_23 = getelementptr %$locals_isdigit$0, %$locals_isdigit$0* %locals_$_0, i64 0, i64 0
 %load_$_24 = load %$locals_tigermain*, %$locals_tigermain** %lnk_$_23
 %var_ptr_$_26 = getelementptr %$locals_isdigit$0, %$locals_isdigit$0* %locals_$_0, i64 0, i64 1
 %res_$_27 = load i8*, i8** %var_ptr_$_26
 %ret_$_28 = call i64 @ord (i8* null, i8* %res_$_27)
 %lnk_$_29 = getelementptr %$locals_isdigit$0, %$locals_isdigit$0* %locals_$_0, i64 0, i64 0
...
define i64 @tigermain (i8* %$sl) {
 ...
 %arg_$_38 = getelementptr %$locals_tigermain, %$locals_tigermain* %locals_$_1, i64 0, i64 0
