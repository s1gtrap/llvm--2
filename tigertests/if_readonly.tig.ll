...
define void @tigermain (i8* %$sl) {
 ...
 %temp_$_2 = getelementptr %$locals_tigermain, %$locals_tigermain* %locals_$_0, i64 0, i64 1
 store i64 0, i64* %temp_$_2
 br label %test_$_3
test_$_3:
 %var_ptr_$_6 = getelementptr %$locals_tigermain, %$locals_tigermain* %locals_$_0, i64 0, i64 1
...
body_$_4:
 %var_ptr_$_15 = getelementptr %$locals_tigermain, %$locals_tigermain* %locals_$_0, i64 0, i64 1
 %res_$_16 = load i64, i64* %var_ptr_$_15
 %cnd_$_17 = icmp ne i64 %res_$_16, 0
 br i1 %cnd_$_17, label %thn_$_12, label %els_$_13
thn_$_12:
 %var_ptr_$_18 = getelementptr %$locals_tigermain, %$locals_tigermain* %locals_$_0, i64 0, i64 1
 %res_$_19 = load i64, i64* %var_ptr_$_18
 store i64 %res_$_19, i64* %temp_$_11
 br label %mrg_$_14
els_$_13:
 %var_ptr_$_20 = getelementptr %$locals_tigermain, %$locals_tigermain* %locals_$_0, i64 0, i64 1
 %res_$_21 = load i64, i64* %var_ptr_$_20
 store i64 %res_$_21, i64* %temp_$_11
 br label %mrg_$_14
mrg_$_14:
 %res_$_22 = load i64, i64* %temp_$_11
 %var_ptr_$_23 = getelementptr %$locals_tigermain, %$locals_tigermain* %locals_$_0, i64 0, i64 1
 %res_$_24 = load i64, i64* %var_ptr_$_23
 %temp_$_25 = add i64 %res_$_24, 1
 %var_ptr_$_26 = getelementptr %$locals_tigermain, %$locals_tigermain* %locals_$_0, i64 0, i64 1
