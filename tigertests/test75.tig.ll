...
define i64 @mod_pos$3 (%$locals_mod$0* %$sl, i64 %a$5, i64 %b$6) {
 ...
 %arg_$_4 = getelementptr %$locals_mod_pos$3, %$locals_mod_pos$3* %locals_$_0, i64 0, i64 2
 store i64 %b$6, i64* %arg_$_4
 %arg_$_5 = getelementptr %$locals_mod_pos$3, %$locals_mod_pos$3* %locals_$_0, i64 0, i64 1
 store i64 %a$5, i64* %arg_$_5
 %arg_$_6 = getelementptr %$locals_mod_pos$3, %$locals_mod_pos$3* %locals_$_0, i64 0, i64 0
 store %$locals_mod$0* %$sl, %$locals_mod$0** %arg_$_6
 br label %test_$_7
test_$_7:
 %var_ptr_$_10 = getelementptr %$locals_mod_pos$3, %$locals_mod_pos$3* %locals_$_0, i64 0, i64 1
 %res_$_11 = load i64, i64* %var_ptr_$_10
 %var_ptr_$_12 = getelementptr %$locals_mod_pos$3, %$locals_mod_pos$3* %locals_$_0, i64 0, i64 2
...
body_$_8:
 %var_ptr_$_17 = getelementptr %$locals_mod_pos$3, %$locals_mod_pos$3* %locals_$_0, i64 0, i64 1
 %res_$_18 = load i64, i64* %var_ptr_$_17
 %var_ptr_$_19 = getelementptr %$locals_mod_pos$3, %$locals_mod_pos$3* %locals_$_0, i64 0, i64 2
 %res_$_20 = load i64, i64* %var_ptr_$_19
 %temp_$_21 = sub i64 %res_$_18, %res_$_20
 %var_ptr_$_22 = getelementptr %$locals_mod_pos$3, %$locals_mod_pos$3* %locals_$_0, i64 0, i64 1
 store i64 %temp_$_21, i64* %var_ptr_$_22
 br label %test_$_7
mrg_$_9:
 %var_ptr_$_23 = getelementptr %$locals_mod_pos$3, %$locals_mod_pos$3* %locals_$_0, i64 0, i64 1
...
define i64 @mod_neg$4 (%$locals_mod$0* %$sl, i64 %a$7, i64 %b$8) {
 ...
 %arg_$_25 = getelementptr %$locals_mod_neg$4, %$locals_mod_neg$4* %locals_$_1, i64 0, i64 2
 store i64 %b$8, i64* %arg_$_25
 %arg_$_26 = getelementptr %$locals_mod_neg$4, %$locals_mod_neg$4* %locals_$_1, i64 0, i64 1
 store i64 %a$7, i64* %arg_$_26
 %arg_$_27 = getelementptr %$locals_mod_neg$4, %$locals_mod_neg$4* %locals_$_1, i64 0, i64 0
 store %$locals_mod$0* %$sl, %$locals_mod$0** %arg_$_27
 br label %test_$_28
test_$_28:
 %var_ptr_$_31 = getelementptr %$locals_mod_neg$4, %$locals_mod_neg$4* %locals_$_1, i64 0, i64 1
...
body_$_29:
 %var_ptr_$_36 = getelementptr %$locals_mod_neg$4, %$locals_mod_neg$4* %locals_$_1, i64 0, i64 1
 %res_$_37 = load i64, i64* %var_ptr_$_36
 %var_ptr_$_38 = getelementptr %$locals_mod_neg$4, %$locals_mod_neg$4* %locals_$_1, i64 0, i64 2
 %res_$_39 = load i64, i64* %var_ptr_$_38
 %temp_$_40 = add i64 %res_$_37, %res_$_39
 %var_ptr_$_41 = getelementptr %$locals_mod_neg$4, %$locals_mod_neg$4* %locals_$_1, i64 0, i64 1
 store i64 %temp_$_40, i64* %var_ptr_$_41
 br label %test_$_28
mrg_$_30:
 %var_ptr_$_42 = getelementptr %$locals_mod_neg$4, %$locals_mod_neg$4* %locals_$_1, i64 0, i64 1
...
define i64 @mod$0 (%$locals_tigermain* %$sl, i64 %a$1, i64 %b$2) {
 ...
 %arg_$_44 = getelementptr %$locals_mod$0, %$locals_mod$0* %locals_$_2, i64 0, i64 6
 store i64 %b$2, i64* %arg_$_44
 %arg_$_45 = getelementptr %$locals_mod$0, %$locals_mod$0* %locals_$_2, i64 0, i64 5
 store i64 %a$1, i64* %arg_$_45
 %arg_$_46 = getelementptr %$locals_mod$0, %$locals_mod$0* %locals_$_2, i64 0, i64 0
 store %$locals_tigermain* %$sl, %$locals_tigermain** %arg_$_46
 %var_ptr_$_51 = getelementptr %$locals_mod$0, %$locals_mod$0* %locals_$_2, i64 0, i64 6
...
thn_$_48:
 %var_ptr_$_60 = getelementptr %$locals_mod$0, %$locals_mod$0* %locals_$_2, i64 0, i64 5
...
thn_$_57:
 %var_ptr_$_65 = getelementptr %$locals_mod$0, %$locals_mod$0* %locals_$_2, i64 0, i64 5
 %res_$_66 = load i64, i64* %var_ptr_$_65
 %var_ptr_$_67 = getelementptr %$locals_mod$0, %$locals_mod$0* %locals_$_2, i64 0, i64 6
 ...
 br label %mrg_$_59
els_$_58:
 %var_ptr_$_70 = getelementptr %$locals_mod$0, %$locals_mod$0* %locals_$_2, i64 0, i64 5
 %res_$_71 = load i64, i64* %var_ptr_$_70
 %var_ptr_$_72 = getelementptr %$locals_mod$0, %$locals_mod$0* %locals_$_2, i64 0, i64 6
...
mrg_$_59:
 ...
 br label %mrg_$_50
els_$_49:
 %var_ptr_$_80 = getelementptr %$locals_mod$0, %$locals_mod$0* %locals_$_2, i64 0, i64 6
...
thn_$_77:
 %var_ptr_$_89 = getelementptr %$locals_mod$0, %$locals_mod$0* %locals_$_2, i64 0, i64 5
...
thn_$_86:
 %var_ptr_$_94 = getelementptr %$locals_mod$0, %$locals_mod$0* %locals_$_2, i64 0, i64 5
 %res_$_95 = load i64, i64* %var_ptr_$_94
 %temp_$_96 = sub i64 0, %res_$_95
 %var_ptr_$_97 = getelementptr %$locals_mod$0, %$locals_mod$0* %locals_$_2, i64 0, i64 6
 ...
 br label %mrg_$_88
els_$_87:
 %var_ptr_$_102 = getelementptr %$locals_mod$0, %$locals_mod$0* %locals_$_2, i64 0, i64 5
 %res_$_103 = load i64, i64* %var_ptr_$_102
 %temp_$_104 = sub i64 0, %res_$_103
 %var_ptr_$_105 = getelementptr %$locals_mod$0, %$locals_mod$0* %locals_$_2, i64 0, i64 6
...
mrg_$_88:
 ...
 br label %mrg_$_79
els_$_78:
 %lnk_$_116 = getelementptr %$locals_mod$0, %$locals_mod$0* %locals_$_2, i64 0, i64 0
 ...
 %lnk_$_111 = getelementptr %$locals_mod$0, %$locals_mod$0* %locals_$_2, i64 0, i64 0
...
define i64 @tigermain (i8* %$sl) {
 ...
 %arg_$_123 = getelementptr %$locals_tigermain, %$locals_tigermain* %locals_$_3, i64 0, i64 0
