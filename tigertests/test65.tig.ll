...
@str_$_7 = global { i64, [1 x i8] } {i64 1, [1 x i8] c"0"}
@str_$_3 = global { i64, [1 x i8] } {i64 1, [1 x i8] c"1"}
...
define i64 @tigermain (i8* %$sl) {
 ...
 %temp_$_8 = bitcast { i64, [1 x i8] }* @str_$_7 to i8*
 %ret_$_9 = call i64 @ord (i8* null, i8* %temp_$_8)
 %temp_$_10 = icmp sge i64 %ret_$_5, %ret_$_9
