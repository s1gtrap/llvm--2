...
define i64 @g$0 (%$locals_tigermain* %$sl, i64 %a$1) {
 ...
 %arg_$_3 = getelementptr %$locals_g$0, %$locals_g$0* %locals_$_0, i64 0, i64 1
 store i64 %a$1, i64* %arg_$_3
 %arg_$_4 = getelementptr %$locals_g$0, %$locals_g$0* %locals_$_0, i64 0, i64 0
 store %$locals_tigermain* %$sl, %$locals_tigermain** %arg_$_4
 %var_ptr_$_5 = getelementptr %$locals_g$0, %$locals_g$0* %locals_$_0, i64 0, i64 1
...
define i64 @g$3 (%$locals_tigermain* %$sl, i64 %a$4) {
 ...
 %arg_$_7 = getelementptr %$locals_g$3, %$locals_g$3* %locals_$_1, i64 0, i64 1
 store i64 %a$4, i64* %arg_$_7
 %arg_$_8 = getelementptr %$locals_g$3, %$locals_g$3* %locals_$_1, i64 0, i64 0
 store %$locals_tigermain* %$sl, %$locals_tigermain** %arg_$_8
 %var_ptr_$_9 = getelementptr %$locals_g$3, %$locals_g$3* %locals_$_1, i64 0, i64 1
...
define i64 @tigermain (i8* %$sl) {
 ...
 %arg_$_11 = getelementptr %$locals_tigermain, %$locals_tigermain* %locals_$_2, i64 0, i64 0
