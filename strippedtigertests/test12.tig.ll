...
define void @tigermain (i8* %$sl) {
 ...
 br label %test_$_4
test_$_4:
 %var_ptr_$_7 = getelementptr %$locals_tigermain, %$locals_tigermain* %locals_$_0, i64 0, i64 1
...
body_$_5:
 %var_ptr_$_12 = getelementptr %$locals_tigermain, %$locals_tigermain* %locals_$_0, i64 0, i64 2
 %res_$_13 = load i64, i64* %var_ptr_$_12
 %temp_$_14 = add i64 %res_$_13, 1
 %var_ptr_$_15 = getelementptr %$locals_tigermain, %$locals_tigermain* %locals_$_0, i64 0, i64 2
 store i64 %temp_$_14, i64* %var_ptr_$_15
 %var_ptr_$_16 = getelementptr %$locals_tigermain, %$locals_tigermain* %locals_$_0, i64 0, i64 1
 %res_$_17 = load i64, i64* %var_ptr_$_16
 %temp_$_18 = add i64 %res_$_17, 1
 %var_ptr_$_19 = getelementptr %$locals_tigermain, %$locals_tigermain* %locals_$_0, i64 0, i64 1
