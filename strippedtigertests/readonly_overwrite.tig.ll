...
body_$_4:
 %var_ptr_$_11 = getelementptr %$locals_tigermain, %$locals_tigermain* %locals_$_0, i64 0, i64 2
 %res_$_12 = load i64, i64* %var_ptr_$_11
 %temp_$_13 = getelementptr %$locals_tigermain, %$locals_tigermain* %locals_$_0, i64 0, i64 1
 store i64 %res_$_12, i64* %temp_$_13
 %var_ptr_$_14 = getelementptr %$locals_tigermain, %$locals_tigermain* %locals_$_0, i64 0, i64 1
