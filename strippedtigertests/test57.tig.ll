...
define i64 @f$0 (%$locals_tigermain* %$sl, i64 %n$1) {
 ...
 %var_ptr_$_8 = getelementptr %$locals_f$0, %$locals_f$0* %locals_$_0, i64 0, i64 1
...
define i64 @tigermain (i8* %$sl) {
 ...
 %arg_$_14 = getelementptr %$locals_tigermain, %$locals_tigermain* %locals_$_1, i64 0, i64 0
 store i8* %$sl, i8** %arg_$_14
 %ret_$_15 = call i64 @f$0 (%$locals_tigermain* %locals_$_1, i64 10)
 %temp_$_16 = getelementptr %$locals_tigermain, %$locals_tigermain* %locals_$_1, i64 0, i64 2
 store i64 %ret_$_15, i64* %temp_$_16
 %ret_$_17 = call i64 @f$0 (%$locals_tigermain* %locals_$_1, i64 0)
 %temp_$_18 = getelementptr %$locals_tigermain, %$locals_tigermain* %locals_$_1, i64 0, i64 1
 store i64 %ret_$_17, i64* %temp_$_18
 %var_ptr_$_19 = getelementptr %$locals_tigermain, %$locals_tigermain* %locals_$_1, i64 0, i64 2
 %res_$_20 = load i64, i64* %var_ptr_$_19
 %var_ptr_$_21 = getelementptr %$locals_tigermain, %$locals_tigermain* %locals_$_1, i64 0, i64 1
