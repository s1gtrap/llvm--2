...
define i8* @tigermain (i8* %$sl) {
 ...
 %field_ptr_$_6 = getelementptr %rectype$0, %rectype$0* %rec_$_5, i64 0, i64 0
 store i64 1000, i64* %field_ptr_$_6
 %temp_$_8 = bitcast { i64, [6 x i8] }* @str_$_7 to i8*
 %field_ptr_$_9 = getelementptr %rectype$0, %rectype$0* %rec_$_5, i64 0, i64 1
 store i8* %temp_$_8, i8** %field_ptr_$_9
...
thn_$_16:
 ...
 br label %mrg_$_17
mrg_$_17:
 %field_ptr_$_20 = getelementptr %rectype$0, %rectype$0* %record_ptr_$_15, i64 0, i64 1
