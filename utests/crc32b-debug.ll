...
define i32 @crc32b(i8*  %var0)  {
  ...
  store i32 -1, i8* %var6
  br label %lbl8
lbl8:                                                ; preds = %var41, %var1
  %var9 = load i8*, i8* %var2
  ;call i32 @printf(i8* @mvar, i32 9, i8* %var9)
  %var10 = load i32, i8* %var3
...
lbl16:                                               ; preds = %var8
  ...
  store i32 %var22, i8* %var5
  %var23 = load i32, i8* %var6
  %var24 = load i32, i8* %var5
  %var25 = xor i32 %var23, %var24
  call i32 @printf(i8* @mvar, i32 25, i32 %var25)
  store i32 %var25, i8* %var6
  store i32 7, i8* %var4
  br label %lbl26

lbl26:                                               ; preds = %var38, %var16
  %var27 = load i32, i8* %var4
...
lbl29:                                               ; preds = %var26
  ...
  store i32 %var32, i8* %var7
  %var33 = load i32, i8* %var6
  %var34 = lshr i32 %var33, 1
  %var35 = load i32, i8* %var7
  ...
  store i32 %var37, i8* %var6
  br label %lbl38

lbl38:                                               ; preds = %var29
  %var39 = load i32, i8* %var4
  %var40 = add  i32 %var39, -1
  call i32 @printf(i8* @mvar, i32 40, i32 %var40)
  store i32 %var40, i8* %var4
  br label %lbl26

lbl41:                                               ; preds = %var26
  %var42 = load i32, i8* %var3
  %var43 = add  i32 %var42, 1
  call i32 @printf(i8* @mvar, i32 43, i32 %var43)
  store i32 %var43, i8* %var3
  br label %lbl8

lbl44:                                               ; preds = %var8
  %var45 = load i32, i8* %var6
...
define i32 @main()  {
  ...
  ;%var7 = call i32 (i8*, i32) @printf(i8*  @.str, i32  %var6)
  ret i32 0
}
