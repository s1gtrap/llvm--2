...
define i32 @main () {
 %1 = alloca i32
 store i32 0, i32* %1
 call void @test (i32 0, i32 2147483647)
 call void @test (i32 -2147483648, i32 -1)
 call void @test (i32 305419896, i32 1842063751)
 call void @test (i32 -1842063752, i32 -305419897)
 call void @test (i32 2147483647, i32 0)
 call void @test (i32 -1, i32 -2147483648)
 call void @testu (i32 0, i32 2147483647)
 call void @testu (i32 -2147483648, i32 -1)
 call void @testu (i32 305419896, i32 1842063751)
 call void @testu (i32 -1842063752, i32 -305419897)
 call void @testu (i32 2147483647, i32 0)
 call void @testu (i32 -1, i32 -2147483648)
 ret i32 0
}
