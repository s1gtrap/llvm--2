...
define i8 @main() {
  ...
  store i8 101, i8* %3
  %4 = getelementptr i8, i8* %1, i32 2
  store i8 108, i8* %4
  %5 = getelementptr i8, i8* %1, i32 3
  store i8 108, i8* %5
  %6 = getelementptr i8, i8* %1, i32 4
  store i8 111, i8* %6
  %7 = getelementptr i8, i8* %1, i32 5
  store i8 44, i8* %7
  %8 = getelementptr i8, i8* %1, i32 6
  store i8 32, i8* %8
  %9 = getelementptr i8, i8* %1, i32 7
  store i8 119, i8* %9
  %10 = getelementptr i8, i8* %1, i32 8
  store i8 111, i8* %10
  %11 = getelementptr i8, i8* %1, i32 9
  store i8 114, i8* %11
  %12 = getelementptr i8, i8* %1, i32 10
  store i8 108, i8* %12
  %13 = getelementptr i8, i8* %1, i32 11
  store i8 100, i8* %13
  %14 = getelementptr i8, i8* %1, i32 12
  store i8 33, i8* %14
  %15 = getelementptr i8, i8* %1, i32 13
  store i8 0, i8* %15
  call i32 @puts(i8* %1)
  %17 = alloca [4 x i32]
