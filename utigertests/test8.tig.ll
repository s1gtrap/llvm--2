...
define i64 @tigermain (i8* %$sl) {
 ...
 %temp_$_6 = icmp sgt i64 10, 20
 %temp_$_7 = zext i1 %temp_$_6 to i64
 %cnd_$_8 = icmp ne i64 %temp_$_7, 0
 br i1 %cnd_$_8, label %thn_$_3, label %els_$_4
thn_$_3:
 store i64 30, i64* %temp_$_2
 br label %mrg_$_5
els_$_4:
 store i64 40, i64* %temp_$_2
 br label %mrg_$_5
mrg_$_5:
 %res_$_9 = load i64, i64* %temp_$_2
 ret i64 %res_$_9
}
